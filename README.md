...
В реализации JWT используется сущность Angular **Interceptor** (перехватчик) - подробнее про них вы можете прочитать в документации https://angular.dev/guide/http/interceptors 
