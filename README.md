...
В реализации JWT в нашем демо используется сущность Angular **Interceptor** (перехватчик) - подробнее про них вы можете прочитать в [`документации`](https://angular.dev/guide/http/interceptors) 
